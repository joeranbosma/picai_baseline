...
enc0.shape torch.Size([3, 24, 32, 256, 256])
enc1.shape torch.Size([3, 24, 16, 128, 128])
enc2.shape torch.Size([3, 48, 8, 64, 64])
enc3.shape torch.Size([3, 96, 4, 32, 32])
dec4.shape torch.Size([3, 384, 1, 8, 8])
dec3.shape torch.Size([3, 192, 2, 16, 16])
dec2.shape torch.Size([3, 96, 4, 32, 32])
dec1.shape torch.Size([3, 48, 8, 64, 64])
dec0.shape torch.Size([3, 24, 16, 128, 128])
out.shape torch.Size([3, 24, 32, 256, 256])
logits.shape torch.Size([3, 2, 32, 256, 256])
outputs.shape torch.Size([3, 2, 32, 256, 256])
