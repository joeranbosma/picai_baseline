...
class SwinUNETR(nn.Module):
    ...
    def forward(self, x_in):
        ...
        enc0 = self.encoder1(x_in); print(enc0.shape)
        enc1 = self.encoder2(hidden_states_out[0]); print(enc1.shape)
        enc2 = self.encoder3(hidden_states_out[1]); print(enc2.shape)
        enc3 = self.encoder4(hidden_states_out[2]); print(enc3.shape)
        dec4 = self.encoder10(hidden_states_out[4]); print(dec4.shape)
        dec3 = self.decoder5(dec4, hidden_states_out[3]); print(dec3.shape)
        dec2 = self.decoder4(dec3, enc3); print(dec2.shape)
        dec1 = self.decoder3(dec2, enc2); print(dec1.shape)
        dec0 = self.decoder2(dec1, enc1); print(dec0.shape)
        out = self.decoder1(dec0, enc0); print(out.shape)
        logits = self.out(out); print(logits.shape)
        return logits
